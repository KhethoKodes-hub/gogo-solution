...
$(function() {
    ...
    // Set up an event listener for the quick booking form.
    $(form).submit(function(event) {
        ...
        .done(function(response) {
            ...
            $(formMessages).text('Thank you! Your booking request has been sent. We will contact you shortly.');
        ...
        .fail(function(data) {
            ...
            // Set the message text.
            $(formMessages).text('Oops! An error occurred and your booking request could not be sent. Please call us at 011 568 5340.');
