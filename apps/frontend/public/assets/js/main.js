...
(function ($) {
    ...
    // Smooth Animation
    // Disable Lenis on touch/mobile devices to prevent scroll-jump behavior.
    var isTouchDevice = window.matchMedia("(hover: none), (pointer: coarse)").matches || window.innerWidth < 992;
    var lenis = null;
    ...
    $(document).ready(function () {
        ...
        // Performance pass: lazy-load non-critical images and keep media decoding async.
        document.querySelectorAll('img').forEach(function (img) {
            var isCritical = img.closest('.slider-section, .page-header, .site-logo, .anniv-logo-stage') !== null;
        ...
        if (!window.__NUXT_MANAGED_SWIPERS) {
            // Main Slider
            var mainSlider;
            var sliderOptions = {
                speed: 1500,
